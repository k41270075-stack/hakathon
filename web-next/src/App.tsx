...
const LIMITS: [string, string][] = [
  [
    ...
    'Свалку отличает необратимость, а чтобы её увидеть, нужны полтора года наблюдений после появления. У свежих объектов их ещё нет.',
  ],
  [
  ...
  [
    ...
    'В промзоне необратимое исчезновение растительности — событие редкое и потому значимое; в поле — рядовое: залежь, смена оборота, заброшенный огород. Проверено на четырёх сельских областях: настоящих свалок ноль.',
  ],
  [
    'Перенос классификатора измерен, но выборка мала',
    'Модель обучена на открытых датасетах — ROC-AUC 0,858 на них. На наших объектах 0,680 при интервале 0,517–0,841. Называем нижнюю границу, а не середину.',
  ],
  [
      ...
      <main className="mx-auto max-w-[1240px] px-6">
          ...
          <div className="grid items-start gap-8 lg:grid-cols-[1.15fr_1fr]">
            <div>
              ...
              <p className="mt-2.5 text-xs text-muted-2">
                Провал не сезонный: сигнал не вернулся. Этим свалка
                отличается от пашни и от гари.
              </p>
            ...
            <div className="lg:pt-2">
              ...
              <p className="mt-5 max-w-[48ch] text-lg leading-relaxed text-muted">
                ...
                экономики. Программа читает восемь лет спутникового архива,
                находит места, где растительность исчезла и{' '}
              ...
              <p className="mt-4 max-w-[48ch] text-sm leading-relaxed text-muted-2">
                Каждый объект просмотрен человеком по снимку 0,4–0,8 м на
                пиксель.
            ...
            <div className="grid gap-10 lg:grid-cols-[1.05fr_1fr]">
              <div>
                ...
                <p className="mt-4 max-w-[56ch] text-muted">
                  ...
                  . Второй — потерянным сырьём: в тех же тоннах лежит
                ...
                <p className="mt-4 max-w-[56ch] text-sm leading-relaxed text-muted-2">
                  Третий счёт не выставят: {num(money.totals.co2e_emitted_t)} т CO₂-экв
          ...
          <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr]">
            <div>
              ...
              <p className="mt-4 max-w-[52ch] text-muted">
                ...
                он платит, он выезжает, он отвечает за результат. Продукт
                устроен вокруг него.
              </p>
            </div>
        ...
        <section id="site" className="border-t border-grid pt-14 pb-16">
          <div className="grid items-center gap-10 lg:grid-cols-[1fr_1fr]">
            <div>
              ...
              <p className="mt-4 max-w-[52ch] text-muted">
                Самый крупный из подтверждённых объектов, снимок 0,75 м на
        ...
        <section id="signals" className="border-t border-grid pt-14 pb-16">
          ...
          <p className="mt-4 max-w-[62ch] text-muted">
            ...
            поверхность изменилась <strong className="font-normal text-line">необратимо</strong>.
          </p>
          <Plates />
          ...
          <p className="mt-8 max-w-[62ch] text-sm leading-relaxed text-muted-2">
            ...
            местности</strong> эти признаки не могут — измеренная точность 0,500,
            то есть случайная. Дальше решают отсев по OpenStreetMap и человек
            со снимком.
          </p>
        </section>
        ...
        {funnel && totals.count > 0 && (
          <section id="funnel" className="border-t border-grid pt-14 pb-16">
            ...
            <p className="mt-4 max-w-[62ch] text-muted">
              На вопрос «а почему выкинули вот это» отвечает файл, а не
              память выступающего.
            </p>
        ...
        <section id="when" className="border-t border-grid pt-14 pb-16">
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-3 max-w-[46ch] text-sm text-muted-2">
                Диапазон по каждому — Монте-Карло по восьми допущениям.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="grid items-baseline gap-8 lg:grid-cols-[1.3fr_1fr]">
            <div>
              ...
              <p className="mt-4 max-w-[58ch] text-muted">
                Модель проверена на объектах, возникших после отсечки, — на
                будущем, которого она не видела. Сто ячеек от модели вместо ста
                случайных дают в сотни раз больше находок на тот же бензин.
              </p>
              <a
                href="./forecast.html"
        ...
        <section id="scale" className="border-t border-grid pt-14 pb-16">
          ...
          <p className="mt-4 max-w-[60ch] text-muted">
            ...
            медиана 223. Без видеокарты, без спутникового контракта, без
            выездов на поиск: снимки Sentinel и Landsat бесплатны и открыты
            всегда, а не на время конкурса.
          </p>
          ...
          <p className="mt-8 max-w-[60ch] text-sm leading-relaxed text-muted-2">
            Последнее число важнее первых двух. Метод работает не везде, и
            где он не сработает, мы говорим <strong className="font-normal text-line">до</strong> прогона —
            за двенадцать минут и без единого снимка. Четыре области из пяти
            дали ноль настоящих свалок, и это написано здесь, а не спрятано.
          </p>
        </section>
        ...
        <section id="limits" className="border-t border-grid pt-14 pb-20">
          ...
          <p className="mt-4 max-w-[58ch] text-muted">
            Инструмент, границы которого неизвестны, применять нельзя.
          </p>
