...
/* Было 320. На первом экране лента стоит в левой колонке рядом с
   заголовком и цифрами, и при такой высоте под ней оставалась пустая
   треть экрана: правая колонка длиннее. Лента — главное изображение
   страницы, растянуть её дешевле и честнее, чем чем-то забивать пустоту. */
const H_WIDE = 510;
const H_NARROW = 620;
