...
/* Именительный падеж, а не родительный.
 *
 * В бланке стояло «Дата возникновения: сентября 2020». Родительный падеж
 * нужен при числе — «12 сентября 2020», — а без числа он читается как
 * обрывок фразы. В официальном документе такое замечают первым, и оно
 * бросает тень на остальные графы.
 *
 * Числа у нас нет и быть не может: детектор работает по месячным
 * композитам, и точность даты — месяц. Значит, и падеж должен быть
 * месячный. */
