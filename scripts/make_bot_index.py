        ...
        items.append(
            {
                ...
                # Сколько независимых поставщиков снимков увидели то же
                # самое. Жителю это понятнее любой вероятности: «два
                # разных спутника показывают одно и то же».
                "verify_providers": int(properties.get("verify_providers") or 0),
            }
        )
