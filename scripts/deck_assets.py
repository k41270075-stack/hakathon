...
── Что снимается ───────────────────────────────────────────────────────
    ...
    rejected     три отвергнутых объекта на снимке высокого разрешения
    map          рабочая карта со списком и картой
...
SHOTS: tuple[tuple[str, str, str], ...] = (
    ("pixel",    "index.html",    "section:nth-of-type(1)"),
    ("funnel",   "index.html",    "section:nth-of-type(4)"),
    ("rejected", "index.html",    "section:nth-of-type(5)"),
